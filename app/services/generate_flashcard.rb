class GenerateFlashcard
  def self.call(podcast)
    ...
    Follow these rules:
    1.	the flashcards will display all key vocabulary of the target language
    ...
    4.  Return a raw JSON with this schema but no extra formatting{ target_vocab: <target language vocabulary>, native_definition: <native language definition>}
    ...
    flashcards.each do |flashcard|
      flashcard_instance = Flashcard.new(flashcard)
      flashcard_instance.podcast = podcast
