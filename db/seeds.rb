...
[user1, user2, user3].each do |user|
  user_language = UserLanguage.create!(user: user, language: "Japanese", level: "Beginner")
  podcast = Podcast.create!(title: "Introduction with これ/それ/あれ",
